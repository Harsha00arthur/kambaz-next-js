...
export default function KambazNavigation() {
  ...
  const links = [
    ...
    { label: "Calendar",  path: "https://northeastern.instructure.com/calendar#view_name=month&view_start=2025-10-07",  icon: IoCalendarOutline },
    { label: "Inbox",     path: "https://northeastern.instructure.com/conversations#filter=type=inbox",     icon: FaInbox },
